...
```{r define_functions}
img_into_dataframe <- function(file_name, cutoff_threshold) {
...
file_name <- 'results/mask_experiment_vi_greenhouse/image_8.jpg'
...
img_df <- img_into_dataframe(file_name, cutoff_threshold = .40)
