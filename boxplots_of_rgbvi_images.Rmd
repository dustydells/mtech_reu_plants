...
```{r define_function}
img_into_dataframe_into_boxplot <- function(file_name, outputdir) {
...
filename = 'results/mask_experiment/image_1.jpg'
...
lapply(filenames, img_into_dataframe_into_boxplot, outputdir = outputdir)
